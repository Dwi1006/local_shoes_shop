...
class TransaksiController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $eco = ecommerce::find($request->id_sepatu);
        $user =  auth()->user();

        if ($eco->stock < $request->jumlah_sepatu) {
            return response()->json([
                'success' => false,
        ...
        $total = $eco->harga * $request->jumlah_sepatu;
        ...
        if ($transaction) {
            $eco->stock = $eco->stock - $request->jumlah_sepatu;
            $eco->save();
            return response()->json([
                'success' => true,
